...
@Component({
  ...
  template: `
    ...
    <div
      style="text-align: center; color: #6b7280; font-size: 16px; margin: 16px 0 12px; font-family: ${FONT};"
    >
      <a
        href="https://github.com/jbaranski/majorleaguesoccer-today"
        target="_blank"
        rel="noopener"
        style="${LINK}"
        >Source code</a
