...
@Component({
  ...
  template: `
    ...
    <div style="text-align: center; color: #6b7280; font-size: 16px; margin: 16px 0 12px; font-family: ${FONT};">
      <a href="https://github.com/jbaranski/majorleaguesoccer-today" target="_blank" rel="noopener" style="${LINK}">Source code</a>
      used to generate the daily fixture list is free and open source :)
    </div>
    <div style="text-align: center; color: #6b7280; font-size: 14px; font-weight: 300; margin-bottom: 12px; font-family: ${FONT};">
      Copyright 2026
      <a href="https://www.jeffsoftware.com" target="_blank" rel="noopener" style="${LINK} font-weight: 400;">Jeff Software</a> |
