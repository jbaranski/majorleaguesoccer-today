  ...
  template: `
    <div class="border-2 border-gray-200 mb-4 overflow-hidden">
      <div class="bg-purple-100 pt-[10px] px-3 pb-[6px] sm:pt-3 sm:px-4 sm:pb-2 border-b-2 border-gray-200">
        <div class="text-sm font-bold uppercase tracking-[0.5px] mb-1 leading-[1.2] text-gray-800">{{ competition() }}</div>
        <div class="text-sm italic text-gray-600 mb-1">{{ formatDate() }}</div>
