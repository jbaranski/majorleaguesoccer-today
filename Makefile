...
sync-plugins:
	...
	@TMPDIR=$$(mktemp -d) && \
	  ...
	  for plugin in jeff-plugin-angular jeff-plugin-aws-solution-architect jeff-plugin-project jeff-plugin-typescript jeff-plugin-tailwind jeff-plugin-shell-bash; do \
